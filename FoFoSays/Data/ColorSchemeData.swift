...
let colorSchemeData: [ColorSchemeModel] = [
    ...
    ColorSchemeModel(colors: [Color(hex: "5F0F40"), Color(hex: "FB8B24"), Color(hex: "E36414"), Color(hex: "9A031E")], title: "Brew", index: 10),
    ColorSchemeModel(colors: [Color(hex: "22092C"), Color(hex: "872341"), Color(hex: "BE3144"), Color(hex: "F05941")], title: "Sunset", index: 11),
    ColorSchemeModel(colors: [Color(hex: "FF008E"), Color(hex: "D22779"), Color(hex: "612897"), Color(hex: "0C1E7F")], title: "Bubble Gum", index: 12),
    ColorSchemeModel(colors: [Color(hex: "222831"), Color(hex: "393E46"), Color(hex: "00ADB5"), Color(hex: "EEEEEE")], title: "Ice Cap", index: 13)
]
